...
const display1 = document.querySelector(".display-number-1") as HTMLDivElement;
const display2 = document.querySelector(".display-number-2") as HTMLDivElement;

const player1Btn = document.getElementById("player1-btn") as HTMLButtonElement;
const player2Btn = document.getElementById("player2-btn") as HTMLButtonElement;
const player1ScoreElem = document.getElementById(
  "player1-score"
) as HTMLElement;
const player2ScoreElem = document.getElementById(
  "player2-score"
) as HTMLElement;
...
function updateUI(display?: HTMLDivElement, hideDisplay?: HTMLDivElement) {
